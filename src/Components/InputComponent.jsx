            ...
            <div className='w-3/4 h-[40vh]'>
                <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 ">
                    ...
                    <div className="px-4 py-2 bg-white rounded-b-lg">
                        ...
                        <textarea onChange={(e) => setUserInput(e.target.value)} id="editor" rows="12" className="block w-full px-0 text-sm text-gray-800 bg-white border-0 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write Your thoughts..." required></textarea>
                    </div>
                </div>
