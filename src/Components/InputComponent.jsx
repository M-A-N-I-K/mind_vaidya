...
const InputComponent = () => {
    ...
    return (
        <div className='w-[85vw] h-[100vh] py-4 overflow-y-scroll flex flex-col justify-between items-center'>
            <div className='w-3/4 h-[40vh]'>
                ...
                <div className="relative flex justify-center py-4 overflow-hidden rounded-lg shadow-lg cursor-pointer">
                    <img className="object-cover rounded-lg w-72" src="https://images.unsplash.com/photo-1502581827181-9cf3c3ee0106?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=420&q=80" alt="Flower and sky" />

                    <div className="absolute top-2 left-60 px-6 py-4">
