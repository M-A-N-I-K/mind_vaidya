                    ...
                    <div className='w-11/12 lg:w-3/4 h-[40vh]'>
                        <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-700 ">
                            <div className="flex items-center justify-center px-3 py-2 border-b ">
                                <button type="button" className="p-2 mx-4 text-gray-50 rounded cursor-pointer hover:text-gray-100 hover:bg-gray-800 ">
                                ...
                                <button type="button" className="p-2 text-gray-50 rounded cursor-pointer hover:text-gray-100 hover:bg-gray-800 ">
                            ...
                            <div className="px-4 py-2 bg-gray-700 shadow-lg rounded-b-lg">
