    ...
    return (
        <nav className="fixed w-[100vw] top-0 h-[10vh] px-4 py-4 flex justify-between items-center bg-gradient-to-r from-gray-900 via-black to-gray-900">
            ...
            <div className="lg:hidden">
                <button onClick={() => setOpenNav(!openNav)} className="navbar-burger flex items-center text-green-600 py-3">
            ...
            {!user ?
                <>
                    ...
                    <Link className="lg:inline-block py-2 px-6 bg-green-500 hover:bg-green-600 text-sm text-white font-bold rounded-xl transition duration-200" to="/signup">
                        Sign up
                    </Link>
                </> : <Link onClick={logout} className="lg:inline-block lg:ml-auto lg:mr-3 py-2 px-4 lg:px-6  bg-green-500 hover:bg-green-600 text-xs lg:text-sm text-white font-bold  rounded-xl transition duration-200" to="/">
                    Logout
                </Link>
            }
        </nav>
